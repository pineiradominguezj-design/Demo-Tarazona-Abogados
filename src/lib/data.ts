...
export const LAWYERS: Record<string, Lawyer> = {
  l1: {
    ...
    email: "l.herrero@demo.despacho.es",
    phone: "+34 600 10 20 30",
    initials: "LH",
  },
  l2: {
    id: "l2",
    ...
    email: "d.prieto@demo.despacho.es",
    phone: "+34 600 10 20 31",
    initials: "DP",
  },
  l3: {
    id: "l3",
    ...
    email: "c.serrano@demo.despacho.es",
    phone: "+34 600 10 20 30",
    initials: "CS",
  },
  l4: {
    ...
    role: {
      es: "Responsable de Laboral",
      en: "Head of Employment Law",
    },
    email: "p.cano@demo.despacho.es",
    phone: "+34 600 10 20 31",
    initials: "PC",
  },
};
  ...
  actions: [
    {
      ...
      detail: {
        es: "Registramos el encargo de renovación de tu autorización de residencia para inversores y te asignamos a Lucía Herrero como letrada responsable.",
        en: "We registered the engagement for the renewal of your investor residence permit and assigned Lucía Herrero as your lead lawyer.",
      },
      attachment: {
  ...
  keyDates: [
    {
      ...
      title: {
        es: "Videollamada de seguimiento con Lucía Herrero",
        en: "Follow-up video call with Lucía Herrero",
      },
...
const caseInmobiliario: Case = {
  ...
  area: "inmobiliario",
  title: {
    es: "Compra de vivienda habitual",
    en: "Purchase of a main home",
  },
  shortTitle: {
  ...
  keyDates: [
    {
      ...
      place: {
        es: "Notaría de D. Enrique Salas · C/ Serrano, 42, Madrid",
        en: "Notary office of Enrique Salas · C/ Serrano, 42, Madrid",
      },
      note: {
        es: "Trae tu pasaporte y tu TIE en vigor. Carmen Serrano te acompañará y habrá intérprete: la escritura se otorga en castellano y tienes derecho a que te la traduzcan antes de firmar.",
        en: "Bring your valid passport and TIE. Carmen Serrano will attend with you and an interpreter will be present: the deed is executed in Spanish and you are entitled to have it translated before signing.",
      },
    },
  ],
  expiries: [],
...
const casePenal: Case = {
  ...
  whatComesNext: {
    es: "Nos reuniremos contigo unos días antes de la vista para preparar tu declaración y explicarte cómo se desarrolla la sesión. Daniel Prieto te acompañará en la sala.",
    en: "We will meet you a few days before the hearing to prepare your statement and explain how the session works. Daniel Prieto will be with you in the courtroom.",
  },
  lawyerId: "l2",
  actions: [
    {
    ...
    },
    {
      ...
      detail: {
        es: "La vista se celebrará el 14 de octubre de 2026 a las 10:00 en el Juzgado de lo Penal nº 4 de Madrid. Se admitió toda la prueba que propusimos.",
        en: "The hearing will take place on 14 October 2026 at 10:00 at Criminal Court no. 4 of Madrid. All the evidence we proposed was admitted.",
      },
      attachment: {
  ...
  keyDates: [
    ...
    },
    {
      ...
      place: {
        es: "Juzgado de lo Penal nº 4 · C/ Julián Camarillo, 11",
        en: "Criminal Court no. 4 · C/ Julián Camarillo, 11",
      },
      note: {
        es: "Preséntate 30 minutos antes en la puerta principal. Daniel Prieto te estará esperando.",
        en: "Arrive 30 minutes early at the main entrance. Daniel Prieto will be waiting for you.",
      },
    },
  ],
  expiries: [],
  ...
  actions: [
    {
      ...
      detail: {
        es: "Recogimos tus objetivos respecto a la custodia, la vivienda y la pensión de alimentos, y te asignamos a Carmen Serrano.",
        en: "We recorded your goals regarding custody, the family home and child support, and assigned Carmen Serrano to your case.",
      },
    },
    {
      id: "a-civ-2",
...
const caseLaboral: Case = {
  ...
  area: "laboral",
  title: {
    es: "Impugnación de despido objetivo por causas económicas",
    en: "Challenge to a dismissal on economic grounds",
  },
  shortTitle: {
    es: "Despido",
    en: "Dismissal",
  ...
  statusLine: {
    es: "Papeleta de conciliación presentada. El acto está señalado para el 30 de septiembre.",
    en: "Conciliation claim filed. The hearing is scheduled for 30 September.",
  },
  whatIsHappening: {
    es: "Hemos presentado la papeleta de conciliación, que es el paso obligatorio antes de acudir al juzgado. El informe pericial que encargamos concluye que las cuentas con las que la empresa justificó el despido no reflejan las pérdidas que alega.",
    en: "We have filed the conciliation claim, the compulsory step before going to court. The expert report we commissioned concludes that the accounts the company used to justify the dismissal do not show the losses it claims.",
  },
  whatComesNext: {
    es: "El acto de conciliación es el 30 de septiembre y Pablo Cano irá contigo. Si la empresa no reconoce la improcedencia o no hay acuerdo, prepararemos la demanda y te la enviaremos para que la leas antes de presentarla. Del plazo para demandar nos ocupamos nosotros.",
    en: "The conciliation hearing is on 30 September and Pablo Cano will attend with you. If the company does not accept that the dismissal was unfair, or no agreement is reached, we will prepare the court claim and send it to you to read before filing. The filing deadline is ours to manage.",
  },
  lawyerId: "l4",
  actions: [
    {
      ...
      detail: {
        es: "Analizamos la carta de despido, el contrato de trabajo con sus anexos y las nóminas del último año para fijar la antigüedad y el salario regulador.",
        en: "We reviewed the dismissal letter, the employment contract with its annexes and the last year's payslips to establish your length of service and reference salary.",
      },
    },
    {
      id: "a-lab-2",
      ...
      published: true,
      title: {
        es: "Recibimos el informe pericial económico",
        en: "We received the expert accounting report",
      },
      formalName: {
        es: "Informe pericial económico sobre las causas alegadas por la empresa",
        en: "Expert accounting report on the grounds alleged by the company",
      },
      detail: {
        es: "El perito concluye que el resultado de explotación de los dos últimos ejercicios fue positivo y que la caída de ingresos que invoca la carta corresponde a una sola línea de negocio, no a la empresa en su conjunto.",
        en: "The expert concludes that operating profit was positive in the last two financial years, and that the drop in revenue cited in the letter relates to a single business line rather than the company as a whole.",
      },
      attachment: {
        name: { es: "Informe pericial económico.pdf", en: "Expert accounting report.pdf" },
        meta: "PDF · 2,1 MB",
      },
    },
    {
      ...
      title: {
        ...
        en: "We filed the conciliation claim",
      },
      formalName: {
        es: "Papeleta de conciliación previa por despido (art. 63 LRJS)",
        en: "Pre-court conciliation claim for unfair dismissal (art. 63 Spanish Employment Courts Act)",
      },
      detail: {
        es: "Quedó registrada ante el servicio autonómico de mediación, arbitraje y conciliación. Reclamamos que se declare improcedente el despido y la diferencia de indemnización que no te abonaron.",
        en: "It was registered with the regional mediation and conciliation service. We are asking for the dismissal to be declared unfair and for the severance shortfall to be paid.",
      },
      attachment: {
        name: { es: "Papeleta de conciliación.pdf", en: "Conciliation claim.pdf" },
        meta: "PDF · 410 KB",
      },
    },
    /* Borrador pendiente de aprobación */
    {
      ...
      published: false,
      title: {
        es: "Ya hay fecha para el acto de conciliación",
        en: "The conciliation hearing has a date",
      },
      formalName: {
        es: "Señalamiento del acto de conciliación y citación de las partes",
        en: "Scheduling of the conciliation hearing and summons to the parties",
      },
      detail: {
        es: "El servicio de mediación ha señalado el acto para el 30 de septiembre a las 10:00 y ha citado a la empresa. Lo hemos añadido a tus próximas fechas.",
        en: "The mediation service has set the hearing for 30 September at 10:00 and has summoned the company. We have added it to your upcoming dates.",
      },
    },
  ],
  firmDocs: [
    {
      id: "fd-lab-1",
      date: "2026-09-11",
      name: { es: "Papeleta de conciliación", en: "Conciliation claim" },
      kind: { es: "Escrito presentado", en: "Filed document" },
      meta: "PDF · 410 KB",
    },
    {
      id: "fd-lab-2",
      date: "2026-08-28",
      name: { es: "Informe pericial económico", en: "Expert accounting report" },
  ...
  docRequests: [
    {
      ...
      help: {
        es: "Lo descargas de la sede electrónica del servicio público de empleo. Nos hace falta para calcular lo que la empresa tendría que devolver si el despido se declara improcedente.",
        en: "You can download it from the public employment service portal. We need it to calculate what the company would have to repay if the dismissal is found unfair.",
      },
      status: "revision",
      requestedOn: "2026-09-12",
    ...
    },
    {
      id: "dr-lab-2",
      name: {
        es: "Carta de despido y contrato de trabajo",
        en: "Dismissal letter and employment contract",
      },
      help: {
        es: "La carta tal y como te la entregaron, con la fecha y la firma visibles, y el contrato con todos sus anexos.",
        en: "The letter exactly as it was handed to you, with the date and signature visible, and the contract with all its annexes.",
      },
      status: "validado",
  ...
  uploadedDocs: [
    {
      id: "ud-lab-1",
      name: {
        es: "Certificado prestación desempleo.pdf",
        en: "Unemployment benefit certificate.pdf",
      },
    ...
    {
      id: "ud-lab-2",
      name: { es: "Carta de despido y contrato.pdf", en: "Dismissal letter and contract.pdf" },
  ...
  keyDates: [
    {
      ...
      place: {
        ...
        en: "Mediation, arbitration and conciliation service",
      },
      note: {
        es: "Pablo Cano irá contigo. Conviene llegar quince minutos antes y llevar el documento de identidad.",
        en: "Pablo Cano will attend with you. It is best to arrive fifteen minutes early and bring your ID document.",
      },
    },
  ],
  expiries: [],
...
export const CLIENTS: Client[] = [
  {
    ...
    phone: "+34 600 30 10 01",
    address: {
      es: "C/ Sagasta, 31, 28004 Madrid",
      en: "C/ Sagasta, 31, 28004 Madrid",
    },
  ...
  },
  {
    ...
    password: "demo1234",
    name: "Javier Molina Ruiz",
    phone: "+34 600 30 10 02",
    address: {
      es: "Avda. de América, 108, 28002 Madrid",
      en: "Avda. de América, 108, 28002 Madrid",
    },
  ...
  },
  {
    ...
    email: "marta@demo.es",
    password: "demo1234",
    name: "Marta Ibáñez Cortés",
    phone: "+34 600 30 10 03",
    address: {
      es: "C/ Alcalá, 220, 28027 Madrid",
      en: "C/ Alcalá, 220, 28027 Madrid",
    },
    ...
    notifyBySms: true,
    demoBlurb: {
      es: "Un único asunto (laboral): el portal la lleva directamente a su ficha sin pasar por el listado.",
      en: "A single matter (employment): the portal takes her straight to the file, skipping the list.",
    },
    authorizedPeople: [],
    accessLog: [
      {
...
export const MESSAGES: Message[] = [
  {
    ...
    caseId: "c-ext",
    from: "despacho",
    authorName: "Lucía Herrero Campos",
  ...
  },
  {
    ...
    caseId: "c-inm",
    from: "despacho",
    authorName: "Carmen Serrano Molina",
  ...
  },
  {
    ...
    caseId: "c-pen",
    from: "despacho",
    authorName: "Daniel Prieto Rubio",
  ...
  },
  {
    ...
    caseId: "c-lab",
    from: "despacho",
    authorName: "Pablo Cano Ibáñez",
    date: "2026-09-11T11:00:00",
    read: true,
    body: {
      es: "Marta, la papeleta quedó presentada esta mañana. Ahora el servicio de mediación señala fecha y cita a la empresa; en cuanto nos llegue el señalamiento te lo pongo en el expediente. Mientras tanto, súbeme el certificado de la prestación por desempleo.",
      en: "Marta, the conciliation claim was filed this morning. The mediation service will now set a date and summon the company; as soon as we receive it I will add it to your file. In the meantime, please upload your unemployment benefit certificate.",
    },
  },
  {
    id: "m-9",
    caseId: "c-lab",
    from: "cliente",
    authorName: "Marta Ibáñez Cortés",
    date: "2026-09-15T08:40:00",
    read: true,
    body: {
      es: "Subido el certificado del paro. ¿Necesitas también el justificante de lo que he cobrado hasta ahora?",
      en: "I have uploaded the unemployment certificate. Do you also need proof of what I have been paid so far?",
    },
    attachment: {
      name: { es: "Certificado prestación desempleo.pdf", en: "Unemployment benefit certificate.pdf" },
      meta: "PDF · 1,6 MB",
    },
  },
];
...
export const ENGAGEMENTS: Engagement[] = [
  ...
  },
  {
    ...
    scope: {
      es: "Impugnación del despido: conciliación previa y, en su caso, demanda ante el juzgado de lo social.",
      en: "Challenge to the dismissal: pre-court conciliation and, if needed, a claim before the employment court.",
    },
    amount: 2900,
    terms: {
...
export const PROVISIONS: FundProvision[] = [
  ...
  },
  {
    ...
    payee: {
      es: "Hacienda autonómica",
      en: "Regional tax authority",
    },
    amount: 24000,
    requestedOn: "2026-09-12",
    status: "pendiente",
  ...
  },
  {
    ...
    caseId: "c-lab",
    concept: {
      es: "Honorarios del perito economista",
      en: "Expert accountant's fees",
    },
    payee: {
      es: "Perito economista independiente",
      en: "Independent expert accountant",
    },
    amount: 1100,
  ...
  },
  {
    ...
    caseId: "c-lab",
    concept: {
      es: "Tasa de obtención de la vida laboral y certificados de cotización",
      en: "Fee for employment history and contribution certificates",
    },
    payee: {
      es: "Gestoría colaboradora",
      en: "Collaborating administrative agency",
    },
    amount: 45,
